...
; Bouwt een installer rond dist\transcribe.exe + dist\ffmpeg.exe + dist\ffprobe.exe
...
;   2. Dubbelklik dit bestand (transcribe.iss) -> opent in Inno Setup IDE
...
;   "C:\Program Files (x86)\Inno Setup 6\ISCC.exe" transcribe.iss
...
SetupIconFile=transcribt.ico
UninstallDisplayIcon={app}\transcribt.ico
Compression=lzma2
...
[Files]
Source: "dist\transcribe.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "dist\ffmpeg.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "dist\ffprobe.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "transcribt.ico"; DestDir: "{app}"; Flags: ignoreversion

[Icons]
Name: "{group}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; IconFilename: "{app}\transcribt.ico"
Name: "{group}\{cm:UninstallProgram,{#MyAppName}}"; Filename: "{uninstallexe}"
Name: "{autodesktop}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; IconFilename: "{app}\transcribt.ico"; Tasks: desktopicon
